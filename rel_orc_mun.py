...
if municipio_selecionado:
    ...
    if not df_filtrado.empty and not df_despesas.empty:
        ...
        # Criar gráfico de barras empilhadas para as receitas correntes, de capital e intraorçamentárias
        ...
        # Criar gráfico de linha para Receita Total
        ...
        # Combinar ambos os gráficos de receita
        ...
        # Criar gráfico de barras empilhadas para as despesas correntes, de capital e intraorçamentárias com cores personalizadas
        ...
        # Criar gráfico de linha para Despesa Total
        ...
        # Combinar ambos os gráficos de despesa
        ...
        st.dataframe(df_capag_exibicao)  # Mostrar o DataFrame filtrado e ajustado na tabela
